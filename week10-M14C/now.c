...
int main(void) {
    ...
    // TODO: Specify Command Line Arguments spawn_fulldate_argv
    ...
    // TODO: Wait using waitpid for process to finish
   int exit_status;
    ...
    printf("date +%%d-%%m-%%Y complete\n");


    // call posix_spawn to print date +%T
    
    pid_t date_time_pid;
    // TODO: Specify Command Line Arguments spawn_time_argv
